...
with open(f"{passwords_dir}{SLASH}10-million-password-list-top-1000000.txt", "r", encoding="utf-8") as tenMilFile:
    tenMilFile.write(r1)
...
if q1.lower().strip().startswith("y"):
    ...
    print("* Writing downloaded data to file")
    with open(f"{passwords_dir}{SLASH}darkweb2017-top10000.txt", "r", encoding="utf-8") as tenMilFile:
        tenMilFile.write(r1)
